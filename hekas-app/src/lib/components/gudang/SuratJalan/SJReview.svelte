...
<div class="space-y-3">
	...
	<label class="block text-sm font-semibold">Catatan review</label><textarea aria-label="Catatan review" bind:value={notes} rows="3" placeholder="Wajib untuk reject" class="w-full px-3 py-2 border rounded-lg text-sm"></textarea>
