...
<div class="relative inline-block">
	...
	{#if open}
		<div class="absolute right-0 mt-1 w-56 bg-white border rounded-lg shadow-lg z-10 p-2">
			...
			<select bind:value={period} class="w-full px-2 py-1 border rounded text-sm mb-2"><option value="today">Hari ini</option><option value="week">7 hari</option><option value="month">30 hari</option></select>
